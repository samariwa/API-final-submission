                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                        <div class="col-md-5 col-sm-5 col-xs-12 form-group top_search" style="padding-left: 75px;">
                            <div class="input-group">
                                <a href="{{route('productcategory.list')}}" class="btn btn-success">View Product Category</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="x_content">
                            ...
                            @if($errors->has('name'))
                                ...
                                <div class="box-footer">
                                    <button type="submit" name="btnCreate" class="btn btn-primary">Update Product Category</button>
                                </div>
                            </form>
                        </div>
                    </div>
